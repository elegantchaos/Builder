[comment]: <> (Header Generated by ActionStatus 1.0 - 208)

[![Test results][tests shield]][actions] [![Latest release][release shield]][releases] [![swift 5.2 shield]][swift] ![Platforms: macOS, Linux][platforms shield]
